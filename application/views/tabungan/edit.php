<?php foreach($datatabungan as $data) {} ?>
			...
			<div class="col-lg-12">
				<div class="card">
					<div class="card-header">
						<h5 class="card-title">Edit Data Tabungan</h5>
					</div>
					<div class="card-body">
						<form action="<?php echo base_url();?>index.php/tabungan/update" method="post">
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group">
										<label>Id Nasabah</label>
										<input type="text" name="id_client" value="<?php echo $data['id_client']; ?>" class="form-control" readonly>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label>Saldo</label>
										<input type="text" name="saldo" value="<?php echo $data['saldo']; ?>" class="form-control">
									</div>
