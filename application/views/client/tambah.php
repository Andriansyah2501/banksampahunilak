        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/client/data">Data Nasabah</a></li>
			...
			<div class="col-lg-12">
				<div class="card">
					<div class="card-header">
						<h5 class="card-title">Tambah Data Nasabah</h5>
					</div>
					<div class="card-body">
						<form action="<?php echo base_url();?>index.php/client/simpan" method="post">
							<div class="row">
								<div class="col-lg-4">
									...
									<div class="form-group">
										<label>No HP</label>
										<textarea name="no_hp" class="form-control" required rows="3"></textarea>
									</div>
								</div>
							</div>
